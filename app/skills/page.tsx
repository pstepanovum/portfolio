  ...
  const certificates = [
    {
      ...
      skills:
        "Cybersecurity fundamentals · Security protocols · Risk management · Network security",
    ...
    },
    {
      ...
      skills:
        "Data analysis · SQL · R programming · Data visualization · Statistical analysis",
      logo: "/images/page/skills/certificates/google.png",
    },
    {
      ...
      skills:
        "Agency Planners · Trafficker · Campaign management · Digital advertising",
      logo: "/images/page/skills/certificates/google.png",
    },
    {
      ...
      skills:
        "English proficiency · Business communication · Written comprehension · Verbal communication",
    ...
    },
    {
      ...
      skills:
        "Google Analytics 4 property setup · Data collection and analysis · Reporting tools utilization · Key measurement features · Website and app analytics",
      logo: "/images/page/skills/certificates/google.png",
    },
  ];
          ...
          <Container>
            <div className="space-y-16">
              <div className="text-center space-y-4">
                ...
                <p className="text-white/60 text-lg max-w-2xl mx-auto">
                  Software, frameworks, and tools I use in my development
                  workflow.
                </p>
              </div>
              <div className="space-y-12">
        ...
        <section className="py-24 relative bg-white/5">
          <Container>
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              <p className="text-white/60 text-lg">
                Interested in collaborating? Let&apos;s discuss how my skills
